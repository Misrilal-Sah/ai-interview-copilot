...
const Solutions: React.FC<SolutionsProps> = ({
  ...
  useEffect(() => {
    ...
    setProblemStatementData(
      (queryClient.getQueryData(["problem_statement"]) as ProblemStatementData | null) ?? null
    )

    const initSolution = queryClient.getQueryData(["solution"]) as {
      code: string
      thoughts: string[]
      time_complexity: string
      space_complexity: string
    ...
    if (initSolution) {
      setSolutionData(initSolution.code ?? null)
      setThoughtsData(initSolution.thoughts ?? null)
      setTimeComplexityData(initSolution.time_complexity ?? null)
      setSpaceComplexityData(initSolution.space_complexity ?? null)
    }
