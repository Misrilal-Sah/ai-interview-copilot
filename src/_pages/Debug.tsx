                        ...
                        <div className="pl-1">
                          {(() => {
                            ...
                            section.content.forEach((line, lineIndex) => {
                              if (skippedIndices.has(lineIndex)) return;
                              ...
                              if (line.trim().startsWith('```')) {
                                ...
                                if (codeBlockEndIndex > lineIndex) {
                                  ...
                                  void language; // used for future syntax highlighting
                                  
                                  const codeContent = section.content
                                    .slice(lineIndex + 1, codeBlockEndIndex)
                                    .join('\n');
                                  
                                  // Mark all lines inside this code block as skipped
                                  for (let i = lineIndex + 1; i <= codeBlockEndIndex; i++) {
                              ...
                              // Regular text
                              renderedLines.push(<div key={lineIndex} className="my-1.5">{line}</div>);
                            });
